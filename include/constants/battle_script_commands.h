...
#define VARIOUS_MODIFY_HEART_VALUE_SENDOUT           168
#define VARIOUS_MODIFY_HEART_VALUE_CALL              169
#define VARIOUS_SET_SHADOW_SKY                       170
#define VARIOUS_TRY_ENTER_REVERSE_MODE               171
